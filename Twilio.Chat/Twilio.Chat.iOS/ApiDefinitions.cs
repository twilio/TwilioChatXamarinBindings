...
namespace Twilio.Chat.iOS
{
    ...
    delegate void NullableCountCompletion (Result result, [NullAllowed] NSNumber count);

    // typedef void (^TCHStringCompletion)(TCHResult * _Nonnull, NSString * _Nullable);
    delegate void StringCompletion (Result result, [NullAllowed] string value);
    ...
    interface Message
    {
        ...
        void GetMediaContentTemporaryUrlWithCompletion (StringCompletion completion);

        // -(void)getMediaWithOutputStream:(NSOutputStream * _Nonnull)mediaStream onStarted:(TCHMediaOnStarted _Nullable)onStarted onProgress:(TCHMediaOnProgress _Nullable)onProgress onCompleted:(TCHMediaOnCompleted _Nullable)onCompleted completion:(TCHCompletion _Nullable)completion __attribute__((deprecated("getMediaWithOutputStream: has been deprecated, please use getMediaContentTemporaryUrlWithCompletion:completion instead and download by URL")));
    ...
    interface Messages
    {
        ...
        // -(void)setNoMessagesConsumedWithCompletion:(TCHNullableCountCompletion _Nullable)completion;
        [Export ("setNoMessagesConsumedWithCompletion:")]
        void SetNoMessagesConsumedWithCompletion ([NullAllowed] NullableCountCompletion completion);
    }
    ...
    interface Members
    {
        // -(NSArray<TCHMember *> * _Nonnull)membersList;
        [Export ("membersList")]
        Member[] MembersList { get; }
    ...
    interface Channel
    {
        ...
        // -(void)getUnconsumedMessagesCountWithCompletion:(TCHNullableCountCompletion _Nonnull)completion;
        [Export ("getUnconsumedMessagesCountWithCompletion:")]
        void GetUnconsumedMessagesCountWithCompletion (NullableCountCompletion completion);
